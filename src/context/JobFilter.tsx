...
//         loading: false,
//         hasMore:
//           prevState.page < data.total_pages &&
...
//         loading: false,
//         hasMore:
//           prevState.page < newData.total_pages &&
...
//   const contextValue: JobContextType = {
//     ...state,
//     // setJobs: (jobs) => setState((prevState) => ({ ...prevState, jobs })),
//     searchJobs: searchJobsAndUpdateState,
//     // setSelectedItem: (selectedItem) => setState((prevState) => ({ ...prevState, selectedItem })),
//     fetchMoreJobs,
//     setState,
//   };
